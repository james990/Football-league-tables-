 ...
 * @author Rob James
 */
@WebServlet(urlPatterns = {"/EnterServ"})
public class EnterServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher requestDispatcher = request.getRequestDispatcher("/WEB-INF/javascript/functions.js");
        ...
        try {
           ...
           //identify sources
            ...
            String XSLFileName = path + "/Enter1.xsl";
            ...
            System.out.println("TransformConfiguration Error: " + ex.getMessage());
        } catch (TransformerException ex){
            System.out.printf("Enountered Transformer Error: " + ex.getMessage());
        } finally {
            out.close();
        }
    }
